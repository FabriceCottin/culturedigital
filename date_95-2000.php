...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "1995-01-01" AND "1999-12-31" ORDER BY `date`.`epoque` ASC');
