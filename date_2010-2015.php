...
<head>
	<title>function 2010-2015</title>
</head>
<body>
<?php
try {
...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "2010-01-01" AND "2014-12-31" ORDER BY `date`.`epoque` ASC');
