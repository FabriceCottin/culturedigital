...
<head>
	<title>function 2000-2005</title>
</head>
<body>
<?php
try {
...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "2000-01-01" AND "2004-12-31" ORDER BY `date`.`epoque` ASC');
