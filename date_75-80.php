...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "1975-01-01" AND "1979-12-31" ORDER BY `date`.`epoque` ASC');
