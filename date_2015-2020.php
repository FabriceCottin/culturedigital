...
<head>
	<title>function 2015-2020</title>
</head>
<body>
<?php
try {
...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "2015-01-01" AND "2020-12-31" ORDER BY `date`.`epoque` ASC');
