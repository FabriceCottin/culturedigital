...
<head>
	<title>function 2005-2010</title>
</head>
<body>
<?php
try {
...
$response = $bdd->query('SELECT epoque, title, description FROM date WHERE epoque BETWEEN "2005-01-01" AND "2009-12-31" ORDER BY `date`.`epoque` ASC');
